  ...
  return (
    <div className="auth">
      <div className="auth__header">
        <p
          className="auth__header-signIn"
          onClick={signInHandler}
          style={{ color: signInShown ? "#0025FF" : "#B4B4B4" }}
        >
          Вход
        </p>

        <p
          className="auth__header-signUp"
          onClick={signUpHandler}
          style={{ color: signUpShown ? "#0025FF" : "#B4B4B4" }}
        >
          Регистрация
        </p>
      </div>
      ...
      <div style={{ display: signInShown ? "block" : "none" }}>
        ...
        <div className="auth__socials">
          <span>или</span>
          <button className="btn auth__socials__btn-google">
            <img src={require("../img/google-icon.svg").default} />
            Войти через Google
          </button>
          <button className="btn auth__socials__btn-fb">
            <img src={require("../img/fb-icon.svg").default} />
            Войти через Facebook
          </button>
          <button className="btn auth__socials__btn-vk">
            <img src={require("../img/vk-icon.svg").default} />
            Войти через VK
          </button>
          <p>
            Ещё нет аккаунта?{" "}
            <span onClick={signUpHandler}>Зарегистрироваться</span>
          </p>
        </div>
      </div>
      ...
      <div style={{ display: signUpShown ? "block" : "none" }}>
        ...
        <form className="auth__form" onSubmit={(e) => handleSubmit(e)}>
          ...
          {signUpValue.password &&
            signUpValue.password2 &&
            signUpValue.password !== signUpValue.password2 && (
              <div className="auth__form__input-error">Пароли не совпадают</div>
            )}
          <button
